...
void MyOled::init() {
    ...
    pageInit[4] = new Text(Vector2(85, 39), 1, "47", "action_P1");
    pageInit[5] = new Text(Vector2(0, 51), 1, "Bouton RESET:", "reset_label_P1");
    pageInit[6] = new Text(Vector2(80, 51), 1, "104", "reset_P1");
    ...
    pageWifi[4] = new Text(Vector2(43, 39), 1, "SAC_Daniel", "ssid_P2");
    pageWifi[5] = new Text(Vector2(10, 51), 1, "PASS:", "pass_label_P2");
    pageWifi[6] = new Text(Vector2(43, 51), 1, "sac_pass", "pass_P2");
    ...
    pageReady[3] = new Text(Vector2(90, 27), 1, "23.00", "temp_P3");
    pageReady[4] = new Text(Vector2(50, 51), 1, "192.168.5.40", "ip_adress_P3");
    ...
    pageOven[2] = new Text(Vector2(70, 15), 1, "Chauffage", "state_P4");
    pageOven[3] = new Text(Vector2(20, 27), 1, "23.00", "temp_P4");
    pageOven[4] = new Text(Vector2(50, 51), 1, "192.168.5.40", "ip_adress_P4");
    _screen->addPage(5, pageOven);

    _screen->changePage(WIFI_PAGE);
}
