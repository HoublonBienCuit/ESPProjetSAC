...
void MyOled::init() {
    ...
    pageOven[2] = new Text(Vector2(70, 15), 1, "", "state_P4");//Attente/Chauffage
    pageOven[3] = new Text(Vector2(20, 27), 1, "", "temp_P4");
    pageOven[4] = new Text(Vector2(50, 51), 1, "", "ip_adress_P4");
